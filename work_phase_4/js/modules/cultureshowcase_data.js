// js/modules/cultureshowcase_data.js

/**
 * A list of cultural showcases for the "Culture Showcase" page.
 * Each showcase contains:
 * - title: the name of the showcase section
 * - images: an array of 3 image paths (used in slides or galleries)
 * - description: a rich HTML-formatted paragraph describing the content
 * - link: a URL (currently "#", can be changed to internal or external page)
 */
